...
class EntertainmentFragment : Fragment(){
    ...
    private var adapter: Entertainment? = null

    private var adLoader: AdLoader? = null
    private var mNativeAds = ArrayList<UnifiedNativeAd?>()
    private var mRecyclerViewItems = ArrayList<Any?>()
    private var AD_UNIT_ID: String = "ca-app-pub-5242580240582734/9966036464"

    private val mWaitHandler = Handler()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val x: View = inflater.inflate(R.layout.fragment_entertainment, container, false)
        ...
        mRecyclerView = x.findViewById(R.id.gist_recycler_view) as RecyclerView
        mRecyclerView!!.setHasFixedSize(true)
        mRecyclerView!!.layoutManager = LinearLayoutManager(this@EntertainmentFragment.context)
        ...
        mDatabase!!.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                adapter = Entertainment(this@EntertainmentFragment.context!!, mRecyclerViewItems)
    ...
    private fun loadNativeAds() {
        if (isNetworkAvailable()){
            val builder = AdLoader.Builder(this@EntertainmentFragment.context!!, AD_UNIT_ID)
